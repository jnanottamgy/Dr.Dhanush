# What the pack photographs actually tell us

Everything below is **transcribed from the images**. Nothing inferred. Where a
field was blank or unreadable on the pack it is listed in the gaps section, not
guessed at.

---

## 1. This is a multi-brand retailer, not a single producer

The single biggest finding. The catalogue contains **their own products and at
least twelve other companies' products**. That changes the storefront
fundamentally: "brand" becomes a product attribute, and manufacturer details
differ per listing rather than being set once for the whole shop.

### Their own — Malnad Spices

| Field | Value |
|---|---|
| Manufactured, packed & marketed by | **MALNAD SPICES** |
| Address | Devaramane, Horanadu Post, Kalasa Tq, Chikmagaluru Dist — 577181 |
| Contact | 8431218956 · 9480956035 |
| Website | www.malnadspices.in |
| FSSAI | **21223055000121** |
| Best before | 8 months (coffee) |

Brands under it: **Swad Coffee** (instant / filter / nice), **Malnad Chai**, and
**Swad Horanadu** (masala powders, marked "Malnad Variety Centre's", *Since 1999*,
same FSSAI).

### Third-party brands they resell

| Brand | Product | Maker / place |
|---|---|---|
| Sanjivini | 1 kg tea | Nagashree Coffee Works, Mahaveera Road, Kalasa 577124 |
| QTF | 1 kg tea powder | Guard-Hitlow Tea Factory, The Mysore Plantations Ltd, Chikmagalur |
| Annapoorneshwari Spices & Malnad Products | Soapnut powder, Sikakai powder | Home made |
| Malenadu Special | Horanadu Nellikai powder | Shree Annapoorneshwari, Horanadu |
| Aradhya | Coconut oil | — |
| Kalpatharu | Pure coconut oil 2 L | Ganesh Flour & Oil Mill |
| Shree Durga | Cold-pressed coconut oil 1 L | — |
| Malnad's Nisarga | Banana stem squash, jamun squash | — |
| Nanjangud Suruchi's | Ginger lime, grapes, jamboo syrups; sugarless jamboo decoction | Nanjangud |
| Hallimane | Kokam syrup | — |
| Hayat | Organic raisins | Pahul Agro |
| Karthik Traders | Mixed dry fruits | Varanga |

Each third-party product needs **its own** manufacturer name, address and FSSAI
number on the listing — not Malnad Spices'.

---

## 2. Three packaging tiers, and only one is listable today

| Tier | Products | Declarations |
|---|---|---|
| **Branded printed packs** | Swad coffees, Malnad Chai, Swad Horanadu masalas, and the third-party brands | Full — FSSAI, maker, address, net weight, MRP, packed-on, batch, best-before, nutrition, veg mark |
| **Clear tubs, name sticker only** | chia, sabja, pumpkin, flax, sunflower, magaz, soapnut | Product name only |
| **Clear poly bags, no label at all** | ~18 whole spices and both dates | **Nothing** |

The bottom two tiers are roughly **25 of 65 products** and cannot be listed as
photographed.

---

## 3. MRPs read directly off packs
...
## 4. Health claims printed on the packaging — needs a decision

Three products carry wording that a food label is not permitted to carry:

- **Diabeat decoction** — the label reads *for diabetic patients*
- **Malenadu Special Nellikai powder** — *rich in Vitamin C and cooling agent for both body and eyes*
- **Amla syrup** — badged *HEALTH DRINK*

Under the Drugs & Magic Remedies (Objectionable Advertisements) Act and the FSSAI
advertising rules, a food cannot claim to treat, prevent or manage a condition.
**Reproducing that wording on the website is riskier than printing it on a pack**,
because an online listing is an advertisement.

Recommendation: list the products, keep the brand names as printed, and write
neutral descriptions. Do not repeat the claim. This one is worth ten minutes with
the client rather than a decision made by me.

---

## 5. Pack photography

The photographs are a genuinely good, consistent set — same wood surface, same
